...
const TicketWallet = () => {
  const { address, account, contract, eventAbi, contractAddr, eventContract, readEventContract } =
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              View and manage your NFT tickets and Token Bound Accounts
            </p>
          </div>
        </div>
        ...
        <Card className="shadow-lg">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-500 text-center max-w-md">
              You don't have any NFT tickets yet. Browse events and purchase tickets to see them
              here.
            </p>
          </CardContent>
        </Card>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-40 bg-gradient-to-br from-deep-blue to-purple-600">
                  ...
                  <div className="absolute top-4 right-4">{getStatusBadge(ticket.event)}</div>
                ...
                <CardContent className="p-5 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {tba && <TransferDialog tba={tba.address} />}
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `https://sepolia.voyager.online/contract/0x${ticket.event.event_ticket_addr.toString(16)}`,
                          '_blank'
                        )
                      }
                    >
