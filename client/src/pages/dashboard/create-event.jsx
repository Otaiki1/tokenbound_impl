          ...
          <CardContent className="grid gap-6">
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2 flex flex-col">
                <label htmlFor="theme" className="text-deep-blue">
                  Event Name
                </label>
                <input
                  id="theme"
              ...
              <div className="space-y-2 flex flex-col">
                <label htmlFor="organizer" className="text-deep-blue">
                  Expected Attendee
                </label>
                <input
                  id="total_ticket"
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2 flex flex-col">
                ...
                <select id="event-type" name="type" value={formData.type} onChange={inputChange}>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-2 flex flex-col">
                ...
                <input type="date" name="endTime" value={formData.endTime} onChange={inputChange} />
              </div>
            </div>
          </CardContent>
